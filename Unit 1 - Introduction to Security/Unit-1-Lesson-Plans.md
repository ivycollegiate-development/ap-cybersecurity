...
**Homework (due Sun 20:30):** Catch up any incomplete lab work. Preview P12: watch the Fireship videos — the original Hugging Face hack (link in Google Classroom, 4:33), the sequel "The most interesting hack in history just got weirder..." (https://youtu.be/0Rp9KJCEIvg, ~6 min, published Sep 2 — OpenAI's postmortem), and optionally Breaking Points' follow-up "OpenAI launches GPT-6 'Astra' as new details emerge about AI agents running wild" (https://youtu.be/JZATZ8im3oQ, ~30 min — segments only; 0:00–7:00 for the launch + second-escape reporting).
